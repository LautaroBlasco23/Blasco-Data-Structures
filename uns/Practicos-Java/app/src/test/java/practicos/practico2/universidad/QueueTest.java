package practicos.practico2.universidad;
...
/*_______________________TESTEAMOS EL METODO enqueue() y dequeue()_____________________________*/
	  @Test public void enqueueDequeue()
  {
	...
	for (int i=999; i>=0; i--)
		...
		fail("Al eliminar elementos de una cola que no est� vac�a lanza la excepci�n EmptyQueueException");
	}

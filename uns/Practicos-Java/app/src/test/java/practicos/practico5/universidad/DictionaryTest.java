package practicos.practico5.universidad;
...
import practicos.practico5.interfaces.*;
import practicos.practico5.hashdictionary.*;
import practicos.practico5.dictionary.*;
import practicos.practico5.exceptions.*;
import practicos.practico5.map.*;
...
public class DictionaryTest {
	...
	public void findAll() {
		...
		Set<Integer> claves= new HashSet<Integer>();
		Random r= new Random();
		Iterator<TDAEntry<Integer,Integer>> it;
		TDAEntry<Integer,Integer> en;
		boolean esta;
	...
	public void Insert_Remove() {
		...
		Set<Integer> claves= new HashSet<Integer>();
		Random r= new Random();
		TDAEntry<Integer,Integer> en=null;
		boolean esta;
	...
	public void entries() {
		...
		for (TDAEntry<Integer, Integer> entrada: s.entries())
